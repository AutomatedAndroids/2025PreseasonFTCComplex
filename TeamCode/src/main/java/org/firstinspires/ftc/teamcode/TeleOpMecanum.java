...
public class TeleOpMecanum extends CommandOpMode {
    ...
    {
        frontLeft = new Motor(hardwareMap, "frontLeftMotor", Motor.GoBILDA.RPM_312);//RPM_435
        frontRight = new Motor(hardwareMap, "frontRightMotor", Motor.GoBILDA.RPM_312);//RPM_312
